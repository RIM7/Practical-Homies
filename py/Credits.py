...
class Credits():
	def __init__(self, master):
		...
		self.root.configure(bg='white'); self.root.title("Practical Homies") 
		self.root.resizable(0, 0)
		self.root.iconbitmap('..\\img\\logos-and-icons\\AEC_logo.ico')
		#self.root.overrideredirect(True)

		credits_img = ImageTk.PhotoImage(Image.open('..\\img\\logos-and-icons\\credits.jpg').resize((540, 300), Image.ANTIALIAS))
		self.credits_label = Label(self.root, image=credits_img,borderwidth=0)
		self.credits_label.place(x=30, y=40)
