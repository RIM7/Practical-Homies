...
class Laser_Diffraction():
    ...
    def __init__(self,master):
        ...
        self.laser_diff_instr.pack(); self.laser_diff_instr.place(x=30, y= 10);
        ...
        Label(self.canvas1,text='1.10cm <= d <= 45cm (suggested)\n2.650nm <= Wavelength <= 720nm.',font=('Courier',12),bg='peach puff3',justify='left').place(x=30, y=205)
        ...
        self.use_x=Button(self.canvas1,bg='peach puff3',text="On",font=("Courier",12,'bold'),anchor=CENTER,command=self.ok_clicked)
        self.use_x.pack(); self.use_x.place(x=355, y= 140); 


        self.Off=Button(self.canvas1,bg='peach puff3',text="Off",font=("Courier",12,'bold'),anchor=CENTER,command=self.off)
        self.Off.pack();self.Off.place(x=300, y=140);
